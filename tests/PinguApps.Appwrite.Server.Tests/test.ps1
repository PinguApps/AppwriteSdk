...
# Generate the report
reportgenerator -reports:coverage.opencover.xml -targetdir:coverage-report -assemblyfilters:+PinguApps.Appwrite.Server riskHotspotsAnalysisThresholds:metricThresholdForCyclomaticComplexity=30
