...
public partial class DatabasesClientTests
{
    ...
    [Fact]
    public async Task GetDocumentGeneric_ShouldIncludeSessionHeaders_WhenProvided()
    {
        // Arrange
        var request = new GetDocumentRequest
        {
    ...
    [Fact]
    public async Task GetDocument_ShouldReturnErrorResponseGeneric_WhenExceptionOccurs()
    {
        // Arrange
        var request = new GetDocumentRequest
        {
