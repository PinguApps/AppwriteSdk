...
public class CreateFloatAttributeRequestValidator : AbstractValidator<CreateFloatAttributeRequest>
{
    public CreateFloatAttributeRequestValidator()
    {
        Include(new CreateAttributeBaseRequestValidator<CreateFloatAttributeRequest, CreateFloatAttributeRequestValidator>());
