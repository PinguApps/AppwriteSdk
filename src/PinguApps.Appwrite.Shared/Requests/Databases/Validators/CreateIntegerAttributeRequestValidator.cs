...
public class CreateIntegerAttributeRequestValidator : AbstractValidator<CreateIntegerAttributeRequest>
{
    public CreateIntegerAttributeRequestValidator()
    {
        Include(new CreateAttributeBaseRequestValidator<CreateIntegerAttributeRequest, CreateIntegerAttributeRequestValidator>());
