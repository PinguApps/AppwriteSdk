...
/// <summary>
/// The request to list indexes of a collection
/// </summary>
public class ListIndexesRequest : DatabaseCollectionIdBaseRequest<ListIndexesRequest, ListIndexesRequestValidator>
{
    /// <summary>
