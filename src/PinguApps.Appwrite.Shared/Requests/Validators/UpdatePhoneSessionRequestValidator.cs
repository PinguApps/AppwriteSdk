...
public class UpdatePhoneSessionRequestValidator : AbstractValidator<UpdatePhoneSessionRequest>
{
    public UpdatePhoneSessionRequestValidator()
    {
        RuleFor(x => x.UserId)
            ...
            .Matches(@"^[a-zA-Z0-9\.\-_]{1,36}$").WithMessage("The user ID must be between 1 and 36 characters long and can only contain a-z, A-Z, 0-9, period, hyphen, and underscore.");
