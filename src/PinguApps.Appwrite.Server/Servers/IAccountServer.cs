...
/// <para><see href="https://appwrite.io/docs/references/1.5.x/server-rest/account">Appwrite Docs</see></para>
/// </summary>
public interface IAccountServer
{
    ...
    /// <para><see href="https://appwrite.io/docs/references/1.5.x/server-rest/account#create">Appwrite Docs</see></para>
    /// </summary>
